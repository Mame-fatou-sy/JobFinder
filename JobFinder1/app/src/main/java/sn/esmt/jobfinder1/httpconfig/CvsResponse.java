...
public class CvsResponse {
    ...
    public CvsResponse(int id, String nom, String prenom, int age, String adresse, String email, String telephone, String specialite, String niveauEtude, String experiencePro) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.age = age;
